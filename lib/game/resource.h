...
/**
   Resource manages resources with BoA. Every entity has some kind of "bag",
where everything is stored. This is it. Resources are identified by strings. You
can get,set,sub and add resources.
