...
GLApp::~GLApp() throw() { checkedDelete(scene); }
...
AGVector2 GLApp::getCamera() const { return scene->getCamera().dim2(); }
...
float GLApp::getCameraHeight(const AGVector2 &p) { return 0; }
