...
AGWindow::AGWindow(AGWidget *pWidget, const AGRect2 &pRect,
...

{
  ...
  for (int y = 0; y < 3; y++)
    for (int x = 0; x < 3; x++) {
      ...
      textures.push_back(
          &getTextureCache()->get(theme.getSurfaceName(borderImage), r));
    }
  ...
  if (pTitle.length()) {
    ...
    AGTable::addChild(
        0, 0, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[0], true));
    AGTable::addChild(
        1, 0, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[1], true));
    AGTable::addChild(
        2, 0, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[2], true));

    AGImage *i1, *i2;

    AGTable::addChild(0, 1,
                      i1 = new AGImage(this, AGRect2(0, 0, bw, titBarHeight),
                                       *textures[3], true));
    // title
    t = dynamic_cast<AGTable *>(
        getTitleBar((int)(width() - 2 * bw), titBarHeight));

    AGTable::addChild(2, 1,
                      i2 = new AGImage(this, AGRect2(0, 0, bw, titBarHeight),
                                       *textures[5], true));
    ...
    AGTable::addChild(
        0, 2, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[3], true));
    AGTable::addChild(
        2, 2, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[5], true));

    AGTable::addChild(
        0, 3, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[6], true));
    AGTable::addChild(
        1, 3, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[7], true));
    AGTable::addChild(
        2, 3, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[8], true));

    AGTable::addChild(
        1, 2,
        mClient = new AGCaption(this, AGRect2(0, 0, 0, 0), "",
                                theme.getFont("window.title.font"),
                                AGBackground(theme, "window.background")));
    ...
    AGTable::addChild(
        0, 1, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[3], true));
    AGTable::addChild(
        2, 1, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[5], true));

    AGTable::addChild(
        0, 2, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[6], true));
    AGTable::addChild(
        1, 2, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[7], true));
    AGTable::addChild(
        2, 2, new AGImage(this, AGRect2(0, 0, bw, bw), *textures[8], true));
...
AGWidget *AGWindow::getClient() { return mClient; }
...
AGWidget *AGWindow::getTitleBar(int w, int h) {
  ...
  t->addChild(0, 0,
              title = new AGCaption(t, AGRect2(0, 0, 0, 0), mTitle,
                                    getTheme()->getFont("window.title.font"),
                                    AGBackground("window.title.background")));
...
void AGWindow::close() { hide(); }

AGRect2 AGWindow::getClientRect() const {
  return const_cast<AGWindow *>(this)->getClient()->getClientRect() +
         mClient->getRect().getV0();
}

AGWindow &toAGWindow(AGWidget &w) { return dynamic_cast<AGWindow &>(w); }
