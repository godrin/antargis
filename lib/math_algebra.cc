...
AGMatrixN::AGMatrixN(const AGMatrix4 &p) : m(4 * 4, 0), mW(4), mH(4) {
...
AGMatrixN::AGMatrixN(const AGMatrix3 &p) : m(3 * 3, 0), mW(3), mH(3) {
...
AGMatrixN::AGMatrixN(size_t w, size_t h) : m(w * h, 0), mW(w), mH(h) {}

AGMatrixN::AGMatrixN(const AGMatrixN &n) : m(n.m), mW(n.mW), mH(n.mH) {}
...
size_t AGMatrixN::width() const { return mW; }
size_t AGMatrixN::height() const { return mH; }
