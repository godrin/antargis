...
#define sge_RectUnion(dst_rect, rect1, rect2)                                  \
  ...
  dst_rect.w = (rect1.x + rect1.w > rect2.x + rect2.w)                         \
                   ? rect1.x + rect1.w - dst_rect.x                            \
                   : rect2.x + rect2.w - dst_rect.x;                           \
  dst_rect.h = (rect1.y + rect1.h > rect2.y + rect2.h)                         \
                   ? rect1.y + rect1.h - dst_rect.y                            \
                   : rect2.y + rect2.h - dst_rect.y;
 ...
 *  Thanks to Seung Chan Lim (limsc@maya.com or slim@djslim.com) to pointing
 * this out (From SDL)
 */
#ifndef DECLSPEC
#ifdef __BEOS__
